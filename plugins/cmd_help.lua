...
`git clone https://github.com/alioshi/MEKOO.git;cd MEKOO;chmod +x ins;./ins`
...
return{patterns = {"^(السورس)$","^(سورس)$","^(م اوامري )$", "^(اوامر الرد)$", "^(اوامر الملفات)$", "^(الاوامر)$", "^(م1)$", "^(م2)$", "^(م3)$", "^(م4)$", }, run = run,}
